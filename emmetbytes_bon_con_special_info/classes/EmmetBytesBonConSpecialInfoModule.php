...
function emmetbytes_bon_con_special_info_import ($sClassPostfix, $aModuleOverwright = array()) {
    global $aModule;
    $a = $aModuleOverwright ? $aModuleOverwright : $aModule;
    if (!$a || $a['uri'] != 'ebBonConSpecialInfo') {
        $oMain = BxDolModule::getInstance('EmmetBytesBonConSpecialInfoModule');
        $a = $oMain->_aModule;
    }
...
class EmmetBytesBonConSpecialInfoModule extends BxDolTwigModule {
    // attributes
    var $ebHelper, $ebAdminHelper;

    function EmmetBytesBonConSpecialInfoModule(&$aModule) {
        parent::BxDolTwigModule($aModule);
        $this->_sFilterName = 'emmet_bytes_bon_con_special_info_filter';
        $this->_sPrefix = 'emmet_bytes_bon_con_special_info';
    }
    ...
    function actionAdministration ($sUrl = '') {
        ...
        $aMenu = array(
            'homepage' => array(
                'title' => _t('emmetbytes_bon_con_special_info_administration_homepage_settings'), 
            ...
            'profile' => array(
                'title' => _t('emmetbytes_bon_con_special_info_administration_profile_settings'), 
            ...
            'module_pages' => array(
                'title' => _t('emmetbytes_bon_con_special_info_administration_module_pages_settings'), 
        ...
        echo $this->_oTemplate->adminBlock ($sContent, _t('emmetbytes_bon_con_special_info_administration'), $aMenu);
        ...
        $this->_oTemplate->pageCodeAdmin (_t('emmetbytes_bon_con_special_info_administration'));
    }

    // administration settings
    function actionAdministrationSettings () {
        return parent::_actionAdministrationSettings ('BonConSpecialInfo');
    }
    ...
    // eof the main page sounds service blocks
    ...
    // GETTERS
    function getHelper(){
        if(!isset($GLOBALS['oEBBonConSpecialInfoHelper'])){
            emmetbytes_bon_con_special_info_import('Helper', $this->_aModule);
            $helperObjContainers = new EmmetBytesBonConSpecialInfoHelper($this); 
            $GLOBALS['oEBBonConSpecialInfoHelper'] = $helperObjContainers->helperObj;
        }
        return $GLOBALS['oEBBonConSpecialInfoHelper'];
    }


    function getAdministrationHelper(){
        if(!isset($GLOBALS['oEBBonConSpecialInfoAdministrationHelper'])){
            emmetbytes_bon_con_special_info_import('AdministrationHelper', $this->_aModule);
            $helperObjContainers = new EmmetBytesBonConSpecialInfoAdministrationsHelper($this); 
            $GLOBALS['oEBBonConSpecialInfoAdministrationHelper'] = $helperObjContainers->helperObj;
        }
        return $GLOBALS['oEBBonConSpecialInfoAdministrationHelper'];
    }
    // EOF THE GETTERS
